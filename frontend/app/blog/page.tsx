...
[Connect Wallet & Get Started](https://cutedsl.com) · [API Docs](https://cutedsl.com/#api-docs) · [Buy $CUTEDSL](https://bags.fm/D322k7ykdgCmNGUZL5XvsgZXdHU4ks8iGoWtfrnmBAGS)`;
...
2. **Connect wallet** on cutedsl.com (Phantom or manual address entry)
...
[Buy $CUTEDSL on bags.fm](https://bags.fm/D322k7ykdgCmNGUZL5XvsgZXdHU4ks8iGoWtfrnmBAGS) and start making API calls in under a minute. Connect your wallet at [cutedsl.com](https://cutedsl.com), deposit tokens, and call any of our 7+ AI services.`,
  },
  {
...
Visit [cutedsl.com](https://cutedsl.com) and click **Connect Wallet** in the top right. If you have Phantom installed, it'll connect automatically. Otherwise, you can paste your wallet address manually.
...
curl -X POST https://cutedsl.com/api/service \\
...
2. Connect wallet at [cutedsl.com](https://cutedsl.com)
...
No signup. No API key. No waiting. Just wallet, tokens, images.`,
  },
  {
    ...
    content: `CuteDSL now hosts a searchable gallery of 100k+ AI-generated images at [cutedsl.com/search](/search). Every image was generated through our Z-Image Turbo engine, and every one is searchable by prompt text, semantic similarity, or both. Here's how we built it.
...
The gallery is live at [cutedsl.com/search](/search). Browse, search, and get inspired. And if you want to generate your own images for as little as $0.04, [grab some $CUTEDSL tokens on bags.fm](https://bags.fm/D322k7ykdgCmNGUZL5XvsgZXdHU4ks8iGoWtfrnmBAGS) and start creating.`,
  },
  {
...
Visit the [CuteDSL Image Gallery](https://cutedsl.com) to see thousands of Z-Image Turbo outputs generated through the API. Every image in the gallery was generated using the CuteZImage pipeline with the exact acceleration techniques described in this ablation.`,
  },
  {
...
Generate images via the CuteDSL API at [$1.00 per generation](https://cutedsl.com/#api-docs). All generations use the full acceleration stack including fused QKV.`,
  },
  {
...
Browse real outputs from the CuteZImage pipeline (including Latent Teleportation experiments) in the [CuteDSL Gallery](https://cutedsl.com). We're continuously generating and publishing images as we test new acceleration techniques.`,
  },
  {
...
1. **Connect your wallet** at [cutedsl.com](https://cutedsl.com) (Phantom auto-detected, or enter address manually)
...
1. [Buy $CUTEDSL on bags.fm](https://bags.fm/D322k7ykdgCmNGUZL5XvsgZXdHU4ks8iGoWtfrnmBAGS)
2. [Connect your wallet](https://cutedsl.com)
3. Deposit credits
